...
<div
	...
	<tr class="text-xs tracking-wide text-left text-gray-500 uppercase dark:border-gray-700 dark:text-gray-400 dark:bg-gray-800 d-flex justify-content-end pb-3">
	<td class="text-gray-700 dark:text-gray-400 mx-3">작성자</td>
	<td class="text-gray-700 dark:text-gray-400 mx-3">조회수 1</td>
	<td class="text-gray-700 dark:text-gray-400 mx-3">2021.08.02</td>
	</tr>
	<tr>
	<td>
	<textarea class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-textarea focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
			rows="10" placeholder="문의 사항을 남겨주세요." style="border:none" readonly></textarea>
	</td>
	</tr>
